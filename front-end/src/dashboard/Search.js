...
export default function Search() {
  ...
  function handleSubmit(event) {
    ...
    listReservations({mobile_number: mobileNumber}, abortController.signal).then(setReservations).catch(setError)
  ...
  return (
    <div>
      <div className="">
        <h2 className="font-weight-bold d-flex justify-content-center mb-4 ">Search</h2>
        ...
        <form className="d-flex justify-content-center">
          ...
          <div className="input-group w-50">
            <input
              ...
              required
            />
            <button className="btn-xs btn-outline-0 btn-outline-dark rounded px-2 pb-1" type="submit" onClick={handleSubmit}>
